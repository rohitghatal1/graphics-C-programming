...
void main() {
    ...
    line(223,405,221,407);
    line(221,407,218,408);
    line(218,408,218,409);
    line(218,409,221,407);
    line(221,407,219,400);
    line(220,406,218,400);
    line(217,407,215,400);
